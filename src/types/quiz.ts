...
export type QuestionProgress = { questionId: string; questionSetId: string; correctCount: number; incorrectCount: number; bookmarked: boolean; lastAnsweredAt?: string };
